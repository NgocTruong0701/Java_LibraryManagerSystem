...
public class PublisherView extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			ArrayList<PublisherObject> publishers = publisher.getPublisherObjects(null, (byte)100);
            request.setAttribute("publishers", publishers);
            RequestDispatcher dispatcher = request.getRequestDispatcher("/WEB-INF/view/PublisherView.jsp");
