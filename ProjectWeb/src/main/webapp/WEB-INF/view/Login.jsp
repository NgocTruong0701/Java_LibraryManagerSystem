...
<link id="theme-style" rel="stylesheet"
	href="/lnt.library/css/portal.css">
<style type="text/css">
					...
					<form enctype="multipart/form-data"
						...
						<div class="form-outline mb-4">
							<input type="text" id="form3Example3"
								...
								placeholder="Enter account name" required="required" /> <label
								class="form-label" for="form3Example3" >Account name</label>
						</div>
						...
						<div class="form-outline mb-3">
							<input type="password" id="form3Example4"
								...
								placeholder="Enter password" required="required" /> <label class="form-label"
						...
						<div class="text-center text-lg-start pt-2">
							<p class="small fw-bold mb-3 text-danger">
								<%= noti %>
							</p>
						</div>
						<% } %>
